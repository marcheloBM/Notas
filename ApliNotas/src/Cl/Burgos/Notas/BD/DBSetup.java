...
public class DBSetup {
    private static final String DB_PATH = "Notas.sqlite";
    private static final String SQL_SCRIPT_DEV = "src/Cl/Burgos/Notas/SQL/Notas.sqlite.sql";
    private static final String SQL_SCRIPT_JAR = "/Cl/Burgos/Notas/SQL/Notas.sqlite.sql";
    ...
    private static boolean tablasExistentes(Connection conn) throws SQLException {
        String[] tablas = { "login", "registropc" };
